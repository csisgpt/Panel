    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="coins">
        <TabsList className="flex flex-wrap gap-2">
          <TabsTrigger value="coins">انواع سکه</TabsTrigger>
          <TabsTrigger value="banks">حساب‌های بانکی</TabsTrigger>
          <TabsTrigger value="works">نام کار</TabsTrigger>
        </TabsList>
                  ...
                  <tbody>
                    {filteredCoins.map((coin) => (
                      <tr key={coin.name} className="border-t">
                        ...
                        <td className="p-2 text-sm text-muted-foreground">{coin.description ?? "-"}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                  ...
                  <tbody>
                    {workNames.data.map((work) => (
                      <tr key={`${work.workName}-${work.metal}`} className="border-t">
                        ...
                        <td className="p-2">{(work as any).category ?? "-"}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
