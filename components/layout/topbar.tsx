...
export function Topbar({ onMenuClick, userName }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b bg-background/90 backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-3 lg:px-10">
        ...
        <div className="flex flex-1 items-center justify-end gap-3">
          <div className={cn("hidden w-80 items-center gap-2 rounded-2xl border bg-card px-3 py-2 shadow-sm lg:flex")}
          >
            <Search className="h-4 w-4 text-muted-foreground" />
            <Input
              placeholder="جستجو در مشتریان، حساب‌ها یا تراکنش‌ها"
